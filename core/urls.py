...
urlpatterns = [
    ...
    path('notas/create/', views.create_notas, name='create_notas'),
    path('notas/update/<int:id>/', views.update_notas,name='update_notas'),
    path('notas/delete/<int:id>/', views.delete_notas,name='delete_notas'),
